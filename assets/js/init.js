...
(function( $ ) {
  ...
  $(document).ready(function() {
    ...
    //
    // Google Map
    var mapLocation = new google.maps.LatLng(34.02743454274454,-117.59445469826458); //change coordinates here
    var marker;
    var map;
    ...
    function initialize() {
      ...
      var contentString = '<div class="map-info-box">'
        + '<p class="map-address"><i class="icon ion-ios-location"></i> Ontario, USA<br><i class="icon ion-ios-telephone"></i> 951-224-5284<br><i class="icon ion-email"></i> <a href="mailto:ronf@coyote.csusb.edu">ronf@coyote.csusb.edu</a></p>'
